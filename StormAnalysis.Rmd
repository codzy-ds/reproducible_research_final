...
kable(financial_data_abs_prop[, c("EVTYPE", "propdmg")], caption = "10 events that causes the most propety damage from 1995 to 2011", col.names = c("EVENTS TYPE", "ABSOLUTE PROPERTY DAMAGES"))

financial_data_abs_crop <- financial_data_abs %>%
  top_n(n =10, wt=cropdmg)
kable(financial_data_abs_prop[, c("EVTYPE", "cropdmg")], caption = "10 events that causes the most crop damage from 1995 to 2011",col.names = c("EVENTS TYPE", "ABSOLUTE CROP DAMAGES"))

financial_data_abs_total <- financial_data_abs %>%
  top_n(n =10, wt=totaldmg)
kable(financial_data_abs_prop[, c("EVTYPE", "totaldmg")], caption = "10  for absolute total damage (crop + property) from 1995 to 2011", col.names = c("EVENTS TYPE", "ABSOLUTE TOTAL DAMAGES"))
```
...
financial_data_rel_prop <- financial_data_rel %>%
  top_n(n=10, wt=propdmg)
kable(financial_data_rel_prop[, c("EVTYPE", "propdmg")], caption = "10 events that causes the most propety damage from 1995 to 2011", col.names = c("EVENTS TYPE", "RELATIVE PROPERTY DAMAGES"))

financial_data_rel_crop <- financial_data_rel %>%
  top_n(n =10, wt=cropdmg)
kable(financial_data_rel_crop[, c("EVTYPE", "cropdmg")], caption = "10 events that causes the most crop damage from 1995 to 2011",col.names = c("EVENTS TYPE", "RELATIVE CROP DAMAGES"))

financial_data_rel_total <- financial_data_rel %>%
  top_n(n =10, wt=totaldmg)
kable(financial_data_rel_total[, c("EVTYPE", "totaldmg")], caption = "10  for absolute total damage (crop + property) from 1995 to 2011", col.names = c("EVENTS TYPE", "RELATIVE TOTAL DAMAGES"))
```
